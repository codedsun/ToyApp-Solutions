...
public class WaitlistContract {
    ...
    // TOO (1) Create an inner class named WaitlistEntry class that implements the BaseColumns interface
    private static final class WaitlistEntry implements BaseColumns{
        ...
        // TDO (2) Inside create a static final members for the table name and each of the db columns
        // TABLE_NAME -> waitlist;
