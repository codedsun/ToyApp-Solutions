...
public class MainActivity extends AppCompatActivity {
    ...
    // TOO (1) Create local EditText members for mNewGuestNameEditText and mNewPartySizeEditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TOO (2) Set the Edit texts to the corresponding views using findViewById
        ...
        // TOO (3) Remove this fake data call since we will be inserting our own data now
    ...
    public void addToWaitlist(View view) {
        ...
        if(mNewGuestNameEditText.getText().toString().isEmpty() || mNewGuestNameEditText.getText().toString().isEmpty()){
            return;
        }
