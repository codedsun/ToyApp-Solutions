...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TOD (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void setupSharedPreferences() {
        ...
        setMinSizeScale(sharedPreferences);
    ...
    private void setMinSizeScale(SharedPreferences sharedPreferences){
        mVisualizerView.setMinSizeScale(Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_show_scale_key),getString(R.string.pref_show_scale_default))));
    }
