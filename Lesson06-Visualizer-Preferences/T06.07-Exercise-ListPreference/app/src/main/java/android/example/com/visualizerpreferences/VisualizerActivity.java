...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // TOsO (4) Update setupSharedPreferences and onSharedPreferenceChanged to load the color
...
//        mVisualizerView.setColor(getString(R.string.pref_color_red_value));
    ...
    private void loadColorFromPreference(SharedPreferences sharedPreferences){
            mVisualizerView.setColor(sharedPreferences.getString(getString(R.string.pref_color_label_key), getString(R.string.pref_color_red_value)));
