...
public class VisualizerActivity extends AppCompatActivity {
    ...
    // TDO (1) Create a new Empty Activity named SettingsActivity; make sure to generate the
    // activity_settings.xml layout file as well and add the activity to the manifest

    // TOO (2) Add a new resource folder called menu and create visualizer_menu.xml
    // TOO (3) In visualizer_menu.xml create a menu item with a single item. The id should be
...
// TOD (5) Add the menu to the menu bar
    // TOO (6) When the "Settings" menu item is pressed, open SettingsActivity
}