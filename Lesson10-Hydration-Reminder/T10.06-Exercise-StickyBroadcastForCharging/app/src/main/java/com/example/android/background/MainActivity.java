...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.M){
            ...
            int battery = intent.getIntExtra(BatteryManager.EXTRA_STATUS,0);
            if(battery== BatteryManager.BATTERY_STATUS_CHARGING || battery == BatteryManager.BATTERY_STATUS_FULL){
                showCharging(true);
            }
        }
