...
public class NotificationUtils {
    ...
    //  TOD (1) Create a method to clear all notifications
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context){
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification
                ,context.getString(R.string.ignore_action),
                PendingIntent.getService(context,12,intent,PendingIntent.FLAG_UPDATE_CURRENT));
        return action;
    ...
    public static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        NotificationCompat.Action action = new NotificationCompat.Action(R.drawable.ic_drink_notification,
                context.getString(R.string.accept_action),PendingIntent.getService(context,13,intent,PendingIntent.FLAG_UPDATE_CURRENT));
        return action;
    }
