...
public class ReminderUtilities {
    ...
    synchronized public static void scheduleChargingReminder(Context context){
        ...
        Job job = firebaseJobDispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setLifetime(SYNC_FLEXTIME_SECONDS)
    ...
    // TOD (16) Create a synchronized, public static method called scheduleChargingReminder that takes
    ...
    // Checkout https://github.com/firebase/firebase-jobdispatcher-android for an example
        // TOD (17) If the job has already been initialized, return
        // TOD (18) Create a new GooglePlayDriver
        // TOD (19) Create a new FirebaseJobDispatcher with the driver
        // TOD (20) Use FirebaseJobDispatcher's newJobBuilder method to build a job which:
        ...
        // TOD (21) Use dispatcher's schedule method to schedule the job
        // TOD (22) Set sInitialized to true to mark that we're done setting up the job
}
