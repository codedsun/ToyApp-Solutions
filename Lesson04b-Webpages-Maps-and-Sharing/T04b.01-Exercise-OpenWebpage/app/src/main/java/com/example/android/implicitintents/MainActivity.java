...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        // TOO (5) Create a String that contains a URL ( make sure it starts with http:// or https:// )

        // TOD (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
       openWebPage(url);
    }
    ...
    // DO (1) Create a method called openWebPage that accepts a String as a parameter
